...
you don't seem to understand the structure of code within functions.
Your indentation is wrong.

In diamond, your else statement is misaligned
Indewnted properly text_anaysis is fine
Caesar,a again after indenting only encodes doesn't decode.
